  ...
  useEffect(() => {
    if (product) {
      setFormData({
        ...
        price: product.price || '',
        category: product.category || 'Sayur',
        stock: product.stock || '',
    ...
    try {
      ...
      if (imageFile) {
        ...
        if (product.image) {
          ...
          if (removeError) console.error('Failed to remove old image:', removeError);
        }
      }
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {product.image && !imageFile && (
                  <div className="mb-2">
                    <img src={supabase.storage.from('product-images').getPublicUrl(product.image).data.publicUrl} alt="Current" className="h-20 w-20 object-cover rounded-lg border border-gray-200" />
                  </div>
                )}
